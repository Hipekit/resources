...
<img src="img/Class文件版本号.png" alt="Class文件版本号" width="50%" height="50%"/>
...
<img src="img/常量池项目类型.png" alt="常量池项目类型" width="50%" height="50%"/>

下图是常量池中17中常量项的结构总览：

<img src="img/常量池数据类型结构.png" alt="常量池数据结构" width="50%" height="50%"/>

### 1.4、访问标志

常量池后的两个字节是访问标志`access_flags`，用于标识类或接口的访问信息，如下图：

<img src="img/访问标志.png" alt="访问标志" width="50%" height="50%"/>
...
<img src="img/字段表结构.png" alt="字段表结构" width="50%" height="50%"/>

字段修饰符都放在access_flags中，是一个u2类型数据

<img src="img/字符访问标志.png" alt="字段访问标志" width="50%" height="50%"/>
...
>
> <img src="img/描述符标识字符含义.png" alt="描述符标识字符含义" width="50%" height="50%"/>
>
...
<img src="img/方法访问标志.png" alt="方法访问标志" width="50%" height="50%"/>
...
<img src="img/属性表结构.png" alt="属性表结构" width="50%" height="50%"/>
...
<img src="img/属性表.png" alt="属性表" width="50%" height="50%"/>

#### 1.8.1、Code属性

方法体中的代码经过编译器处理后，变为字节码指令存储在Code属性中。

<img src="img/Code属性表结构.png" alt="Code属性表的结构" width="50%" height="50%"/>
...
* `exception_table`：显示异常处理表，可以不存在
  ...
  > 异常表结构：
  >
  > <img src="img/异常表结构.png" alt="异常表结构" width="50%" height="50%"/>
  >
...
<img src="img/Exception属性结构.png" alt="Exception属性结构" width="50%" height="50%"/>
...
<img src="img/LineNumberTable属性结构.png" alt="LineNumberTable属性结构" width="50%" height="50%"/>
...
<img src="img/LocalVariableTable属性结构.png" alt="LoalVariableTable属性结构" width="50%" height="50%"/>

`local_variable_info`类型代表的是栈桢与源码中局部变量的关联，其结构如下图：

<img src="img/local_variable_info项目结构.png" alt="local_variable_info项目结构" width="50%" height="50%"/>
...
<img src="img/SourceFile结构.png" alt="SourceFile结构" width="50%" height="50%"/>

* `sourcefile_index`：源码文件的名字

`SourceDebugExceptions`属性用于存储额外的自定义的代码调试信息

<img src="img/SourceDebugExceptions结构.png" alt="SourceDebugExceptions结构" width="50%" height="50%"/>
...
<img src="img/ConstantValue属性.png" alt="ConstantValue属性" width="50%" height="50%"/>
...
<img src="img/InnerClasses属性.png" alt="InnerClasses结构" width="50%" height="50%"/>

* `number_of_classes`：内部类的数量
* `inner_classes`：内部类的信息列表，每一项都是`inner_classes_info`类型，其结构如下图：

<img src="img/inner_classes_info结构.png" alt="inner_classes_info表结构" width="50%" height="50%"/>
...
<img src="img/inner_classes_access_flags标志.png" alt="inner_class_access_flags标志" width="50%" height="50%"/>
